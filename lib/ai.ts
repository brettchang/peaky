...
export async function generateCopyForPlacements(input: {
  ...
  const response = await anthropic.messages.create({
    ...
    max_tokens: 4096,
    system: `You are a copywriter for The Peak, a daily business newsletter. You write ad copy that fits seamlessly into the newsletter's editorial voice — smart, concise, and conversational. The tone is professional but not stiff, informative but engaging.
